...
const labelClass =
  "block text-[11px] font-medium text-[#7B1C1C]/70 tracking-wide uppercase mb-1.5";
        ...
        >
          {sent ? (
            ...
            >
              ...
              <h3 className="font-serif text-[26px] text-[#7B1C1C]">Message envoyé !</h3>
              ...
              <button
                onClick={() => {
                  setSent(false);
                  setForm({ nom: "", email: "", telephone: "", role: "", sujet: "", message: "" });
                }}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              <div>
                ...
                <h2 className="font-serif text-[28px] text-[#7B1C1C]">Envoyez-nous un message</h2>
              </div>
